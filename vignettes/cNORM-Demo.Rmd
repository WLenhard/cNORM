...
# for children age 2 to 18 for the ppvt dataset. That way, the age 
# variable is recoded into a discrete group variable with 12 distinct
# groups. The resulting vector specifies the mean age
# of each group.
